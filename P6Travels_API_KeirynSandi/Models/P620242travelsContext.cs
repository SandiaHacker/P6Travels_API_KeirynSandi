...
namespace P6Travels_API_KeirynSandi.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("SERVER=.;DATABASE=P62024_2Travels;INTEGRATED SECURITY=FALSE;User Id=P620242;Password=123Queso;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Country>(entity =>
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D160BFD3831FB2");
        ...
        {
            entity.HasKey(e => e.DestionationId).HasName("PK__Destinat__12F2541F55DFF660");
        ...
        {
            entity.HasKey(e => e.HostingId).HasName("PK__Hosting__B2C2DF841DAAB6FE");
        ...
        {
            entity.HasKey(e => e.ReservationId).HasName("PK__Reservat__B7EE5F044B486B26");
        ...
        {
            entity.HasKey(e => e.ActivityId).HasName("PK__Schedule__45F4A7F1CBA24FF7");
        ...
        {
            entity.HasKey(e => e.TourId).HasName("PK__Tour__604CEA10B1BE2DC0");
        ...
        {
            entity.HasKey(e => e.TransportId).HasName("PK__Transpor__19E9A17D6980D883");
        ...
        {
            entity.HasKey(e => e.TravelId).HasName("PK__Travel__E9315215E573FAE8");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC12BD8B65");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A55DAFF62ED");
